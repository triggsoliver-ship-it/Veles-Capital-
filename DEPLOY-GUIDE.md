# Veles Capital — Deploy Guide

Plain-English, step-by-step instructions to get **velescapital.net** live **today**. No coding required.
...
A folder called `velescapital` containing the whole website:
...
1. Go to **https://formspree.io** and click **Sign up**. Use **rene@velescapital.net**.
2. Verify your email when Formspree asks.
3. Click **+ New form**. Name it `Veles Capital website`. Set the send-to address to **rene@velescapital.net**. Click **Create form**.
...
3. Drag your entire **velescapital** folder onto the upload area.
4. Click **Deploy**. After ~30 seconds you'll get a live URL like `velescapital-xxxx.vercel.app`. Open it to check everything works.
...
4. Type: `cd ` (with a space), then drag the **velescapital** folder into the window and press Enter. This moves you into the folder.
...
### Step 3 — Connect velescapital.net
1. In Vercel, open your project → **Settings → Domains**.
2. Type **velescapital.net** and click **Add**. Also add **www.velescapital.net** (Vercel will offer to redirect one to the other — accept).
...
1. Log in to wherever you bought **velescapital.net** (GoDaddy, Namecheap, IONOS, 123-Reg, etc.).
...
2. Vercel issues a free **HTTPS certificate** automatically, so `https://velescapital.net` will be secure with a padlock.
3. Visit **https://velescapital.net** and click through every page and the contact form to confirm all is well.
...
- [ ] `velescapital.net` and `www.velescapital.net` both load over HTTPS.
